...
const JewelryBanner = () => {
  ...
  const main_slider_setting = {
    ...
    autoplaySpeed: 4000, // Change image every 3 seconds
  };
  ...
  // Update video play/pause based on play state
  useEffect(() => {
            ...
            <div className="tp-slider-video-wrapper">
              <div className={`tp-slider-video transition-3 ${play ? 'full-width' : ''}`}>
                <video loop muted preload="auto">
                  <source src="/assets/vid/jewelvid.mp4" type="video/mp4" />
                </video>
              </div>
                ...
                <div className="col-xl-6 col-lg-6 col-md-8">
                  <div className="tp-slider-content-4 p-relative z-index-1">
                    ...
                    <div className="tp-slider-btn-4">
                      <Link href="/imgup" className="tp-btn tp-btn-border tp-btn-border-white">Get Started</Link>
                    </div>
                  </div>
                </div>
              </div>
